...
it('searches current apartment and recommends better apartments in the same region', async () => {
  vi.stubGlobal('fetch', vi.fn((input: string | URL | Request) => {
    ...
    const body = url.includes('/api/apartments?')
      ? [{ id: 1, name: '현재아파트', address: '서울 A', regionId: 10, regionName: '마포구', buildYear: 2010 }]
      : [{ apartmentId: 2, apartmentName: '추천아파트', address: '서울 B', averagePricePerPyeong: 80_000_000, gapPerPyeong: 20_000_000, tradeCount: 5 }]
