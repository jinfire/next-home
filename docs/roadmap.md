...
- [x] 장기 수집 429·5xx·타임아웃 자동 재시도
- [x] 완료 지역·월 체크포인트 기반 이어받기
- [x] 구버전 수집 로그 체크포인트 복구 명령
- [x] 페이지당 1,000건으로 API 호출 절감

- [x] 네이버 Dynamic Map 기본 지도 유지 결정
- [x] 자체 SVG 급지지도 시안 검토 후 미채택
- [ ] 카카오 JavaScript 키 발급 및 허용 도메인 등록
- [ ] 네이버·카카오 지도 공급자 어댑터 분리
- [ ] 콘솔 한도 또는 명확한 SDK 오류 기반 카카오 전환
- [ ] 실제 트래픽 증가 시 유료 지도·자체 타일 재평가

## 가격지수 급지 방식 완료 (2026-07-21)
...
## 독립 연도 탐색 완료 (2026-07-21)

- [x] 지도 연도 슬라이더
- [x] 갈아타기 연도 슬라이더
- [x] 아파트 추천 최신 연도 자동 선택

## 우리집·역사적 격차 표시 완료 (2026-07-21)

- [x] 우리집 최신 월 평균 평단가
- [x] 34평 현재 추가 금액
- [x] 34평 역대 최소·최대 추가 금액
- [x] 과거 데이터 부족 상태 표시

## 완결된 최신 월 선택 완료 (2026-07-21)

- [x] 지역·월 수집 완료 영속화
- [x] 수도권 전체 완료 월 판정
- [x] 부분 수집 월 추천 반영 방지

## 최신 월 아파트 비교 완료 (2026-07-21)

- [x] 최신 수집 한 달 기준 평단가 비교
- [x] 최신 수집 한 달 기준 거래 건수
- [x] 추천 결과에 거래 연월 명시
- [x] DB 최신 계약월 자동 추적
- [ ] 연속된 최신 3개월 수집 완료 후 3개월 비교로 전환

## 가격 비교 표현 보정 완료 (2026-07-21)

- [x] 면적별 총가격을 현재 대비 추가 금액으로 변경
- [x] 확실한 상위 가격 아파트 우선 추천
- [x] 실제 수집 월 범위의 오해 없는 표기

## 아파트 검색 범위 개선 완료 (2026-07-21)
