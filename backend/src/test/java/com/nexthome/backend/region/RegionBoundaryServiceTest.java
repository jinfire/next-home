...
class RegionBoundaryServiceTest {
    ...
    @Test
    void returnsOnlyBoundariesThatHaveAGradeForTheRequestedYear() throws Exception {
        try (Connection connection = DriverManager.getConnection(postgres.getJdbcUrl(), postgres.getUsername(), postgres.getPassword());
            ...
            statement.execute("INSERT INTO region VALUES (1,'11680','강남구',ST_Multi(ST_GeomFromText('POLYGON((127 37,128 37,128 38,127 38,127 37))',4326))), (2,'00000','경계없음',NULL)");
        ...
        assertThat(geoJson).contains("FeatureCollection", "강남구", "\"grade\": 1", "coordinates");
